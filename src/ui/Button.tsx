...
function Button({
  ...
  return (
    <button
      className={`bg-stone-200 dark:bg-purple-600 text-stone-950 dark:text-stone-50 fill-purple-700 dark:fill-stone-50 font-semibold uppercase cursor-pointer border-stone-950 dark:border-purple-900 active:border-b-1 rounded-md  transition-all duration-200
        ${
          size === "big"
